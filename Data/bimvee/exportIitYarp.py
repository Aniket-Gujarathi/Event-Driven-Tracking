...
def exportDvs(dataFile, data, **kwargs):
    # f = open("/home/aniket/gaze_tracking/Python_new/Python/yarp_out_real/batch01/ch0dvs/data.log.txt", "a")
    # print(data['ts'])
    ...
    minTimeStepPerBottle = kwargs.get('minTimeStepPerBottle', 2e-6)
    ...
    while ptr < numEvents:
        ...
        # if (data['pol'][ptr] == True):
        #     f.write(str(0) + " " + str(data['ts'][ptr]) + " " + str(1) + " " + str(data['x'][ptr]) + " " + str(data['y'][ptr]) + " " + str(0) + " " + str(0) + "\n")
        # else:
        #     f.write(str(0) + " " + str(data['ts'][ptr]) + " " + str(0) + " " + str(data['x'][ptr]) + " " + str(data['y'][ptr]) + " " + str(0) + " " + str(0) + "\n")
        ptr = nextPtr
        bottleNumber += 1 
